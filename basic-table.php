      ...
      <div class="container-fluid page-body-wrapper" style="margin-top:40px">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row">
            <h2>hai annas saputra</h2>
              <a href="logout.php"
              style="background-color: salmon;color:white;width: 80px;height:40px;text-align: center;text-decoration: none;box-shadow: 0px 0px 10px rgba(0,0,0,0.5);">Log Out</a>
